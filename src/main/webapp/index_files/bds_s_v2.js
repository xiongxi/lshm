var bdShare = bdShare || {version: "1.0"};
(function () {
    var P = new Date().getTime();
    var N = new Date().getTime();
    var L = new Date().getTime();
    var F = window, V = document, X = V.body, R = V.documentElement, A = {}, G = "", I = V.title, h = [], O = "", C = {}, S = V.getElementById("bdshare_js").attributes.data, K = /MSIE 6.0/.test(navigator.userAgent), g = V.compatMode != "CSS1Compat", S = S.nodeValue.replace(/&amp;/g, "&").split("&") || "";
    try {
    ...
    var Z = {
        ...
        _parseJson: function (j) {
            ...
            var E = document.createElement("SCRIPT"), U = 0, l = T || {}, D = l.charset, k = W || function () {
                }, j = l.timeOut || 0, B;
            ...
            var T = Z.bdPref, B = E.split(","), W = B[1], D = "#", U = T + B[0] + " " + B[2];
            return {name: W, url: D, cls: U}
        }, list_s: function (j) {
            var i = [], U = inner = "", W = Z, B = W.bdList, E = W.bdNums, e = (W.bdNums < B.length) ? '<li><a href="#" class="bds_more">' + W.bdMore + "</a></li>" : "";
            while (E--) {
            ...
            var u = J.getSize(), D = q, n = {t: 0, l: 0}, B = /gecko/.test(navigator.userAgent), m = function (o, e) {
                n.t += o, n.l += e
            };
            if (D && D != X) {
                if (D.getBoundingClientRect) {
                    var p = D.getBoundingClientRect(), r = q.ownerDocument, W = r.body, T = r.documentElement, E = T.clientTop || W.clientTop || 0, k = T.clientLeft || W.clientLeft || 0;
                    if (p.top == p.bottom) {
                    ...
                    while (D) {
                        ...
                        if (B) {
                            var i = parseInt(j.getPropertyValue("border-left-width"), 10) || 0, t = parseInt(j.getPropertyValue("border-top-width"), 10) || 0;
                            m(t, i);
        ...
        var l = /(#\d+\-[a-zA-Z\d]+\-\d+\-\d+\-[a-f\d]{32}$)/g, T = (A.search + A.hash).replace(/&/g, "#"), D = T.match(l) || "", o = new RegExp(Z.bdWList, "ig"), e = A.protocol + "//" + A.hostname + A.pathname + A.search;
        ...
        if (Z.tongji == "on" || D != "" || typeof j != "undefined") {
            ...
            if (typeof j != "undefined") {
                ...
                for (var E = 0, U = k.length; E < U; E++) {
                    p[{tools: 0, button: 1, slide: 2}[k[E]]] = 1
                }
        ...
        create: function () {
            var i = Z, k = i.bdList, D = k.length, T = [], E = "", l = J.getSize(), B = V.getElementById(i.bdIds + "_pop"), e = ((K || g) ? "absolute" : "fixed"), j = ((K || g) ? l.t : 0);
            if (!B) {
                while (D--) {
            ...
            J.on(F, "resize", function (o) {
                var m = J.getSize(), n = "left:" + (m.w / 2 - U.offsetWidth / 2) + "px;top:" + (j + m.h / 2 - U.offsetHeight / 2) + "px";
                J.setAttr(U, n);
                J.setAttr(O, n)
            });
            if (i.bdType != "slide") {
        ...
        bind: function (D, B, U, T) {
            ...
            if (B.nodeName == i.toUpperCase()) {
                if (i == "a" || i == "span") {
                    var j = B.className, D = j == "goWebsite" ? j : j.split(" ")[0].split("_")[1], E = this;
                    if (D) {
            ...
            if (AX != "goWebsite") {
                ...
                if (AX == "bdxc") {
                    ...
                    if (AT[AO]) {
                        ...
                        AK.src = "http://xiangce.baidu.com/zt/collect/mark.js?" + (new Date()).getTime();
                    ...
                    if (AX == "bdysc") {
                        ...
                        if (window.baiduSC_yaq4d3elabjnvmijccc1zuo3o4yeizck) {
                            ...
                            AN.src = "http://s.wenzhang.baidu.com/js/pjt/content_ex/page/bookmark.js?s=baidu_fenxiang&_t=" + Math.random();
    ...
    bdShare.fn = (function () {
        return {
            init: function () {
                ...
                this.type = D;
                var E = V.querySelectorAll ? V.querySelectorAll(".shareCount") : V.getElementsByTagName("*"), B = E.length;
                while (B--) {
                ...
                J.list_s(true);
                var i = this.b, q = this.t, D = i.length, r = q.length, B = V.getElementById(this.conf.bdIdsl), E = V.getElementById("bdsIfr"), k = this.conf.bdList, n = k.length;
                        ...
                        if (q[r].id == "bdshare") {
                            ...
                            while (U--) {
                                ...
                                if (/bds_more/.test(e.className)) {
                                    ...
                                    for (var T = 0; T < n; T++) {
                                        if (k[T]) {
                                            var W = k[T].split(","), o = new RegExp(this.conf.bdPref + W[0] + "$", "ig");
                                            if (k[T]) {
                                                var W = k[T].split(","), o = new RegExp(this.conf.bdPref + W[0] + "$", "ig");
                ...
                if (!F._bdS) {
                    var k = this.conf.bdLeft == "right" ? "left" : "right", e = this.conf.bdHost + "images/" + this.conf.bdLeft.substring(0, 1) + this.conf.bdImg + ".gif";
                    F._bdS = J.html({
                        id: this.conf.bdIds,
                ...
                var j = this, E = _bdS, n = J.getSize(), l = V.getElementById(this.conf.bdIdsl), T = V.getElementById("bdsIfr"), W = (!K && !g) ? "fixed" : "absolute", i = (K ? n.t : 0) + (this.conf.bdTop == 0 ? (n.h < l.offsetHeight ? -40 : (n.h / 2 - l.offsetHeight / 2)) : parseInt(this.conf.bdTop));
